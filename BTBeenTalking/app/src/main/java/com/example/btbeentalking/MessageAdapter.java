...
public class MessageAdapter  extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder messageViewHolder, @SuppressLint("RecyclerView") final int position)
    {
        ...
        messageViewHolder.messageReceiverPic.setVisibility(View.GONE);
        ...
        if(fromMessageType.equals("text"))
        {
            ...
            if(fromUserID.equals(messageSenderId))
            {
                ...
                messageViewHolder.senderMessageText.setBackgroundResource(R.drawable.send_message_layout);
        ...
        else if(fromMessageType.equals("image"))
        {
            ...
            {
                messageViewHolder.messageReceiverPic.setVisibility(View.VISIBLE);
                Picasso.get().load(messages.getMessage()).into(messageViewHolder.messageReceiverPic);
        ...
        else if(fromMessageType.equals("pdf") || fromMessageType.equals("docx"))
        {
            ...
            {
                messageViewHolder.messageSenderPic.setVisibility(View.VISIBLE);
                messageViewHolder.messageSenderPic.setBackgroundResource(R.drawable.file);
            ...
            {
                messageViewHolder.messageReceiverPic.setVisibility(View.VISIBLE);
                messageViewHolder.messageReceiverPic.setBackgroundResource(R.drawable.file);
        ...
        else
        {
            ...
            messageViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {
                    if(userMessagesList.get(position).getType().equals("pdf") || userMessagesList.get(position).getType().equals("doc") )
                    {
                        CharSequence options[] = new CharSequence[]
                                {
                                        "Download and view this doc",
